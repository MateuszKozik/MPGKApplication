...
class UpdateOverview extends Component {
    ...
    componentDidUpdate(props) {
        if (this.props.overview !== props.overview) {
            const { overviewId, status, startTime, endTime, parameter, comment } = this.props.overview;
            this.setState({
...
export default connect(mapStateToProps, { getOverview, updateOverview })(UpdateOverview);
